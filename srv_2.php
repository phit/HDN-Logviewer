...
echo '<b>Physics Server Chat Logs for '.$day2.'.'.$month2.'.'.$year2.' - Timezone UTC + 2 hours </b><b id="rfloat"><a href="javascript:history.go(0)">refresh the page</a></b>';
