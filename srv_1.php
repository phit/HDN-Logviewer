...
echo '<b>Main Server Chat Logs for '.($day2<10?"0".$day2:$day2).'.'.($month2<10?"0".$month2:$month2).'.'.$year2.' - Timezone UTC + 2 hours </b><b id="rfloat"><a href="javascript:history.go(0)">refresh the page</a></b>';
...
?>
		<hr color="000000">
		» eupublic-hdn.tk, &copy; <a href="http://steamcommunity.com/id/phit">phit</a> 2014
		</div>
	</body>
</html>